...
var sceneData=[
    ...
    {id:1,name:'shoushushi',tooltip:'手术室',width:18,height:18,x:318,y:33},
    {id:2,name:'zhenshi',tooltip:'诊室',width:18,height:18,x:485,y:115},
    {id:3,name:'danganshi',tooltip:'档案室',width:18,height:18,x:290,y:115},
    {id:4,name:'zhuyuanbu',tooltip:'住院部',width:18,height:18,x:230,y:33},
    {id:5,name:'yingxiangshi',tooltip:'影像室',width:18,height:18,x:170,y:33},
    {id:6,name:'jianchashi',tooltip:'检查室',width:18,height:18,x:115,y:33},
    {id:7,name:'shoushuzhunbeishi',tooltip:'手术准备室',width:18,height:18,x:230,y:115},
    {id:8,name:'zhusheshi',tooltip:'注射室',width:18,height:18,x:170,y:115},
    {id:9,name:'chuzhishi',tooltip:'处置室',width:18,height:18,x:290,y:193},
    {id:10,name:'huayanshi',tooltip:'化验室',width:18,height:18,x:230,y:193},
    {id:11,name:'mianyishi',tooltip:'免疫室',width:18,height:18,x:230,y:287}
];
